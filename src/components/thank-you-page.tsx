...
export function ThankYouPage() {
  ...
  const whatsappLink = "https://chat.whatsapp.com/Dw80ccqjE9mIxokupkSvsd";
      ...
      <div className="container mx-auto px-4 py-8 max-w-6xl">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-xl md:text-2xl text-muted-foreground max-w-4xl mx-auto leading-relaxed">
            Você garantiu sua vaga no nosso <span className="text-primary font-semibold">Curso Gratuito!</span> O evento será nos dias <span className="text-primary font-semibold">19, 20 e 21 de Maio.</span>
          </p>
        </div>
